#ifndef _APP_CAN_YB103_CANDBCMSG_H_
#define _APP_CAN_YB103_CANDBCMSG_H_
...
typedef struct {
    // 0x200 - ABS_1
    // Byte 0
    uint8_t ABS_FLWheelSpeed_Part1 : 8;
    // Byte 1
    uint8_t ABS_FLWheelSpeedRC_Part1 : 2;
    uint8_t ABS_FLWheelSpeedValid : 1;
    uint8_t ABS_FLWheelSpeed_Part0 : 5;
    // Byte 2
    uint8_t ABS_FLWheelSpeedRC_Part0 : 8;
    // Byte 3
    uint8_t ABS_FRWheelSpeed_Part1 : 8;
    // Byte 4
    uint8_t ABS_FRWheelSpeedRC_Part1 : 2;
    uint8_t ABS_FRWheelSpeedValid : 1;
    uint8_t ABS_FRWheelSpeed_Part0 : 5;
    // Byte 5
    uint8_t ABS_FRWheelSpeedRC_Part0 : 8;
    // Byte 6
    uint8_t ABS_1_RollingCounter : 4;
    uint8_t ABS_FLWheelSts : 2;
    uint8_t ABS_FRWheelSts : 2;
    // Byte 7
    uint8_t ABS_1_Checksum : 8;
} ABS_1_0x200_Struct;

typedef struct {
    // 0x201 - ABS_2
    // Byte 0
    uint8_t ABS_RLWheelSpeed_Part1 : 8;
    // Byte 1
    uint8_t ABS_RLWheelSpeedRC_Part1 : 2;
    uint8_t ABS_RLWheelSpeedValid : 1;
    uint8_t ABS_RLWheelSpeed_Part0 : 5;
    // Byte 2
    uint8_t ABS_RLWheelSpeedRC_Part0 : 8;
    // Byte 3
    uint8_t ABS_RRWheelSpeed_Part1 : 8;
    // Byte 4
    uint8_t ABS_RRWheelSpeedRC_Part1 : 2;
    uint8_t ABS_RRWheelSpeedValid : 1;
    uint8_t ABS_RRWheelSpeed_Part0 : 5;
    // Byte 5
    uint8_t ABS_RRWheelSpeedRC_Part0 : 8;
    // Byte 6
    uint8_t ABS_2_RollingCounter : 4;
    uint8_t ABS_RLWheelSts : 2;
    uint8_t ABS_RRWheelSts : 2;
    // Byte 7
    uint8_t ABS_2_Checksum : 8;
} ABS_2_0x201_Struct;
...
typedef struct {
    ...
    uint8_t BCM_BrakeLightSts : 2;
    uint8_t BCM_ReverseLightSts : 2;
    // Byte 3
    uint8_t Reserve_3 : 8;
    // Byte 4
    uint8_t Reserve_4 : 8;
    ...
    uint8_t Reserve_5 : 8;
    // Byte 6
    uint8_t Reserve_6_0 : 7;
    uint8_t BCM_BackMirrorFolderSts : 1;
    // Byte 7
    uint8_t Reserve_7 : 8;
} BCM_1_0x360_Struct;
...
typedef struct {
    ...
    uint8_t Reserve_1_2 : 2;
    uint8_t IHU_FLSeatVentLvlSet : 4;
    // Byte 2
    uint8_t Reserve_2_0 : 4;
    uint8_t IHU_FRSeatVentLvlSet : 4;
    // Byte 3
    uint8_t Reserve_3 : 8;
    // Byte 4
    uint8_t Reserve_4 : 8;
...
typedef struct {
    ...
    uint8_t Reserve_6 : 8;
    // Byte 7
    uint8_t EHPS_1_Timeout_Flag : 1;
    uint8_t Swaybar_1_Timeout_Flag : 1;
    uint8_t Reserve_7 : 6;
} GW_PC_4_0x3A0_Struct;
...
typedef struct {
    ...
    uint8_t Reserve_4_3 : 1;
    uint8_t SCU_1_FLSeatVentLvlSts : 4;
    // Byte 5
    uint8_t Reserve_5_0 : 4;
    uint8_t SCU_1_FRSeatVentLvlSts : 4;
    // Byte 6
    uint8_t Reserve_6 : 8;
    // Byte 7
    ...
    uint8_t Reserve_7 : 5;
} GW_BD_29_0x3CC_Struct;

typedef enum {
    CanTxMsgIndex_ACU_1_0x350,
    CanTxMsgIndex_ESP_2_0x211,
    CanTxMsgIndex_ABS_1_0x200,
    CanTxMsgIndex_ABS_2_0x201,
    CanTxMsgIndex_TPMS_1_0x365,
    CanTxMsgIndex_BCM_1_0x360,
    CanTxMsgIndex_BCM_3_0x311,
    CanTxMsgIndex_BCM_4_0x362,
    CanTxMsgIndex_BCM_5_0x312,
    CanTxMsgIndex_PEPS_1_0x268,
    CanTxMsgIndex_PEPS_3_0x269,
//    CanTxMsgIndex_IC_1_0x375,
//    CanTxMsgIndex_IC_2_0x376,
//    CanTxMsgIndex_IHU_1_0x300,
//    CanTxMsgIndex_IHU_2_0x542,
//    CanTxMsgIndex_IHU_3_0x90,
//    CanTxMsgIndex_IHU_4_0x3B0,
//    CanTxMsgIndex_IHU_5_0x3B1,
//    CanTxMsgIndex_IHU_6_0x91,
//    CanTxMsgIndex_IHU_7_0x580,
//    CanTxMsgIndex_IHU_8_0x581,
//    CanTxMsgIndex_IHU_9_0x582,
//    CanTxMsgIndex_IHU_10_0x92,
    CanTxMsgIndex_TBOX_1_0x598,
    CanTxMsgIndex_TBOX_2_0x599,
    CanTxMsgIndex_TBOX_4_0x317,
    CanTxMsgIndex_FCM_3_0x302,
    CanTxMsgIndex_FCM_4_0x303,
    CanTxMsgIndex_FCM_5_0x304,
    CanTxMsgIndex_FCM_6_0x305,
    CanTxMsgIndex_FCM_7_0x306,
    CanTxMsgIndex_FCM_8_0x307,
    CanTxMsgIndex_GW_PC_1_0x150,
    CanTxMsgIndex_GW_PC_6_0x155,
    CanTxMsgIndex_GW_PC_2_0x250,
    CanTxMsgIndex_GW_PC_7_0x255,
    CanTxMsgIndex_GW_PC_4_0x3A0,
    CanTxMsgIndex_GW_BD_9_0x3A7,
    CanTxMsgIndex_GW_BD_14_0x3AC,
    CanTxMsgIndex_GW_BD_24_0x3C7,
    CanTxMsgIndex_GW_BD_29_0x3CC,
    CanTxMsgIndex_Max = 31
} CanTxMsgIndex_Type;

typedef union {
    uint8_t Data[8];
    ACU_1_0x350_Struct Bit_0x350;
    ESP_2_0x211_Struct Bit_0x211;
    ABS_1_0x200_Struct Bit_0x200;
    ABS_2_0x201_Struct Bit_0x201;
    TPMS_1_0x365_Struct Bit_0x365;
    BCM_1_0x360_Struct Bit_0x360;
    BCM_3_0x311_Struct Bit_0x311;
    BCM_4_0x362_Struct Bit_0x362;
    BCM_5_0x312_Struct Bit_0x312;
    PEPS_1_0x268_Struct Bit_0x268;
    PEPS_3_0x269_Struct Bit_0x269;
    IC_1_0x375_Struct Bit_0x375;
    IC_2_0x376_Struct Bit_0x376;
    IHU_1_0x300_Struct Bit_0x300;
    IHU_2_0x542_Struct Bit_0x542;
    IHU_3_0x90_Struct Bit_0x90;
    IHU_4_0x3B0_Struct Bit_0x3B0;
    IHU_5_0x3B1_Struct Bit_0x3B1;
    IHU_6_0x91_Struct Bit_0x91;
    IHU_7_0x580_Struct Bit_0x580;
    IHU_8_0x581_Struct Bit_0x581;
    IHU_9_0x582_Struct Bit_0x582;
    IHU_10_0x92_Struct Bit_0x92;
    TBOX_1_0x598_Struct Bit_0x598;
    TBOX_2_0x599_Struct Bit_0x599;
    TBOX_4_0x317_Struct Bit_0x317;
    FCM_3_0x302_Struct Bit_0x302;
    FCM_4_0x303_Struct Bit_0x303;
    FCM_5_0x304_Struct Bit_0x304;
    FCM_6_0x305_Struct Bit_0x305;
    FCM_7_0x306_Struct Bit_0x306;
    FCM_8_0x307_Struct Bit_0x307;
    GW_PC_1_0x150_Struct Bit_0x150;
    GW_PC_6_0x155_Struct Bit_0x155;
    GW_PC_2_0x250_Struct Bit_0x250;
    GW_PC_7_0x255_Struct Bit_0x255;
    GW_PC_4_0x3A0_Struct Bit_0x3A0;
    GW_BD_9_0x3A7_Struct Bit_0x3A7;
    GW_BD_14_0x3AC_Struct Bit_0x3AC;
    GW_BD_24_0x3C7_Struct Bit_0x3C7;
    GW_BD_29_0x3CC_Struct Bit_0x3CC;
...
#endif//_APP_CAN_YB103_CANDBCMSG_H_
