...
uint8_t g_Page0menu_index = 0;//MENU_UNDEFINE;
uint8_t g_Page0item_index = 0;//ITEM_DEFAULT;

uint8_t g_Page1menu_index = 0;//MENU_UNDEFINE;
uint8_t g_Page1item_index = 0;//ITEM_DEFAULT;
