...
char* GW_PC_2Item[GW_PC_2_ITEM_MAX] = {
    "ABS_VhSd", "ABS_SpdV", "ABS_TmOt", "ESP_ESPF", "ESP_TCSA", "ESP_ESPA",
    "ESP_ESPO", "ABS_Act", "EPB_AtVl", "EPB_AtA", "EPB_ActL", "EPB_WrnL",
    "EPB_AtS", "ESP_HDCF", "ESP_DVT", "ABS_ABSF", "ESP_HDC", "SAS_Cal",
    "SAS_Fail", "SAS_AngV", "ABS_EBDF", "ABS_EBDA", "SAS_Ang", "EPB_Inh",
    "SAS_TmOt", "ESP_TCSF", "EPB_TmOt", "ESP_TmOt"
};
...
uint32_t IHU_8Max[IHU_8_ITEM_MAX] = {
    4,
    4,
    16,
	0x3FFFFFFF,
...
uint32_t g_IHU_8[IHU_8_ITEM_MAX] = {0};
...
char* GW_PC_1Item[GW_PC_1_ITEM_MAX] = {
    "EMS2_ES", "EMS2_ESV", "EMS2_TO", "EMS3_SSF", "EMS3_SSA",
    "EMS3_SSt", "EMS3_ERS", "EMS3_SS", "TCU1_AGV", "TCU1_TOW",
    "TCU3_DM", "TCU1_AG", "TCU1_SR", "TCU1_GSV", "TCU1_GSP",
    "TCU1_IcI", "EMS3_ES", "TCU3_TO", "TCU1_TO", "EMS3_TO", "TCU1_TF"
};
