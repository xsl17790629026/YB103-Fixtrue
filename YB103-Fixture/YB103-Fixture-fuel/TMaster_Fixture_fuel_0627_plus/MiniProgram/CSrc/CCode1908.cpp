...
// CODE BLOCK BEGIN Timer TBOX_2_Timer MTAwMA__
// 定时器文档 "TBOX_2_Timer"
TMPTimerMS TBOX_2_Timer;
// CODE BLOCK END Timer TBOX_2_Timer
...
//电源分配故障报警
u32 PEPS_PowerRelayOutputFail_signal;
//PEPS系统
u32 PEPS_SSB_FailStatus_signal;
u32 PEPS_KeyBatteryWarning_signal;
u32 PEPS_NotPNWarning_signal;
u32 PEPS_BrakeIndicationWarning_signal;
u32 PEPS_NoKeyFoundWarning_signal;
u32 PEPS_KeyIntWarning1_signal;
u32 PEPS_LockNotOFFWarning_signal;
//AWD和EDL状态通知
u32 AWD_1_OpreationNotice_signal;
u32 EDL_1_StatusNotice_signal;
//TCU相关信号
u32 TCU_1_ShiftRecommendation_signal;
u32 TCU_1_IcInformaition_signal; 
//请退出2H/4L模式后切换此驾驶模式报警/请先切换至4L，再进行操作
u32 TCU_3_DrivemodeOprationNotice_signal;
//AEB系列报警
u32 FCM_AEBTextInfo_signal;
//ACC系列报警
u32 FCM_ACCTextInfo_signal;
// EPB禁止起步通知
u32 EPB_1_InhibitDriveOffNotice_signal;
//ACC接管请求
u32 FCM_ACCTakeOverReq_signal; 
//前置摄像头故障警告
u32 FCM_CameraTextInfo_signal;
//SOS系统故障报警
u32 TBOX_EcallErr_signal;
//稳定杆报警
u32 Swaybar_1_StatusNotice_signal;
//门开预警
u32 BCM_1_FrontLeftDoorSts_signal;
u32 BCM_1_FrontRightDoorSts_signal;
u32 BCM_1_RearLeftDoorSts_signal;
u32 BCM_1_RearRightDoorSts_signal;
u32 BCM_1_TailGateOpenSts_signal;
u32 BCM_1_HoodSts_signal;
...
app.get_system_var_uint32("EPB_1_InhibitDriveOffNotice", &EPB_1_InhibitDriveOffNotice_signal);
...
GW_PC_2_1.set_EPB_1_InhibitDriveOffNotice(EPB_1_InhibitDriveOffNotice_signal);
...
app.get_system_var_uint32("TCU_1_ShiftRecommendation", &TCU_1_ShiftRecommendation_signal);
app.get_system_var_uint32("TCU_1_IcInformaition", &TCU_1_IcInformaition_signal);
...
GW_PC_1_1.set_TCU_1_ShiftRecommendation(TCU_1_ShiftRecommendation_signal);
GW_PC_1_1.set_TCU_1_IcInformaition(TCU_1_IcInformaition_signal);
...
app.get_system_var_uint32("TCU_3_DrivemodeOprationNotice", &TCU_3_DrivemodeOprationNotice_signal);
...
GW_PC_6_1.set_TCU_3_DrivemodeOprationNotice(TCU_3_DrivemodeOprationNotice_signal);
...
app.get_system_var_uint32("BCM_1_FrontLeftDoorSts", &BCM_1_FrontLeftDoorSts_signal);
app.get_system_var_uint32("BCM_1_FrontRightDoorSts", &BCM_1_FrontRightDoorSts_signal);
app.get_system_var_uint32("BCM_1_RearLeftDoorSts", &BCM_1_RearLeftDoorSts_signal);
app.get_system_var_uint32("BCM_1_RearRightDoorSts", &BCM_1_RearRightDoorSts_signal);
app.get_system_var_uint32("BCM_1_TailGateOpenSts", &BCM_1_TailGateOpenSts_signal);
app.get_system_var_uint32("BCM_1_HoodSts", &BCM_1_HoodSts_signal);
...
GW_BD_9_1.set_BCM_1_FrontLeftDoorSts(BCM_1_FrontLeftDoorSts_signal);
GW_BD_9_1.set_BCM_1_FrontRightDoorSts(BCM_1_FrontRightDoorSts_signal);
GW_BD_9_1.set_BCM_1_RearLeftDoorSts(BCM_1_RearLeftDoorSts_signal);
GW_BD_9_1.set_BCM_1_RearRightDoorSts(BCM_1_RearRightDoorSts_signal);
GW_BD_9_1.set_BCM_1_TailGateOpenSts(BCM_1_TailGateOpenSts_signal);
GW_BD_9_1.set_BCM_1_HoodSts(BCM_1_HoodSts_signal);
...
app.get_system_var_uint32("AWD_1_OpreationNotice", &AWD_1_OpreationNotice_signal);
app.get_system_var_uint32("EDL_1_StatusNotice", &EDL_1_StatusNotice_signal);
...
GW_PC_7_1.set_AWD_1_OpreationNotice(AWD_1_OpreationNotice_signal);
GW_PC_7_1.set_EDL_1_StatusNotice(EDL_1_StatusNotice_signal);
...
app.get_system_var_uint32("FCM_AEBTextInfo", &FCM_AEBTextInfo_signal);
app.get_system_var_uint32("FCM_ACCTextInfo", &FCM_ACCTextInfo_signal);
app.get_system_var_uint32("FCM_ACCTakeOverReq", &FCM_ACCTakeOverReq_signal);
app.get_system_var_uint32("FCM_CameraTextInfo", &FCM_CameraTextInfo_signal);
...
FCM_3_1.set_FCM_AEBTextInfo(FCM_AEBTextInfo_signal);
FCM_3_1.set_FCM_ACCTextInfo(FCM_ACCTextInfo_signal);
FCM_3_1.set_FCM_ACCTakeOverReq(FCM_ACCTakeOverReq_signal);
FCM_3_1.set_FCM_CameraTextInfo(FCM_CameraTextInfo_signal);
...
app.get_system_var_uint32("PEPS_PowerRelayOutputFail", &PEPS_PowerRelayOutputFail_signal);
app.get_system_var_uint32("PEPS_SSB_FailStatus", &PEPS_SSB_FailStatus_signal);
app.get_system_var_uint32("PEPS_KeyBatteryWarning", &PEPS_KeyBatteryWarning_signal);
app.get_system_var_uint32("PEPS_NotPNWarning", &PEPS_NotPNWarning_signal);
app.get_system_var_uint32("PEPS_BrakeIndicationWarning", &PEPS_BrakeIndicationWarning_signal);
app.get_system_var_uint32("PEPS_NoKeyFoundWarning", &PEPS_NoKeyFoundWarning_signal);
app.get_system_var_uint32("PEPS_KeyIntWarning1", &PEPS_KeyIntWarning1_signal);
app.get_system_var_uint32("PEPS_LockNotOFFWarning", &PEPS_LockNotOFFWarning_signal);

PEPS_1_1.init();

PEPS_1_1.set_PEPS_FailStatus(PEPS_FailStatus_signal);
PEPS_1_1.set_PEPS_PowerRelayOutputFail(PEPS_PowerRelayOutputFail_signal);
PEPS_1_1.set_PEPS_SSB_FailStatus(PEPS_SSB_FailStatus_signal);
PEPS_1_1.set_PEPS_KeyBatteryWarning(PEPS_KeyBatteryWarning_signal);
PEPS_1_1.set_PEPS_NotPNWarning(PEPS_NotPNWarning_signal);
PEPS_1_1.set_PEPS_BrakeIndicationWarning(PEPS_BrakeIndicationWarning_signal);
PEPS_1_1.set_PEPS_NoKeyFoundWarning(PEPS_NoKeyFoundWarning_signal);
PEPS_1_1.set_PEPS_KeyIntWarning1(PEPS_KeyIntWarning1_signal);
PEPS_1_1.set_PEPS_LockNotOFFWarning(PEPS_LockNotOFFWarning_signal);
...
app.get_system_var_uint32("Swaybar_1_StatusNotice", &Swaybar_1_StatusNotice_signal);
...
GW_PC_4_1.set_Swaybar_1_StatusNotice(Swaybar_1_StatusNotice_signal);
...
// CODE BLOCK BEGIN On_Timer On_TBOX_2_Timer VEJPWF8yX1RpbWVy
// 定时器触发事件 "On_TBOX_2_Timer" for Timer TBOX_2_Timer
void on_timer_On_TBOX_2_Timer(void) { try { // 定时器 = TBOX_2_Timer
TTBOX_2_1 TBOX_2_1;  

app.get_system_var_uint32("TBOX_EcallErr", &TBOX_EcallErr_signal);

TBOX_2_1.init();

TBOX_2_1.set_TBOX_EcallErr(TBOX_EcallErr_signal);

com.transmit_can_async(&TBOX_2_1.FCAN); 

} catch (...) { log_nok("CRASH detected"); app.terminate_application(); }}
// CODE BLOCK END On_Timer On_TBOX_2_Timer
